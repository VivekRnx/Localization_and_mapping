...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<std::string>("lio_sam/pointCloudTopic", pointCloudTopic, "/os_cloud_node/points");
        nh.param<std::string>("lio_sam/imuTopic", imuTopic, "/imu/data");
        nh.param<std::string>("lio_sam/odomTopic", odomTopic, "odometry/imu");
        nh.param<std::string>("lio_sam/gpsTopic", gpsTopic, "odometry/gpsz");

        nh.param<std::string>("lio_sam/lidarFrame", lidarFrame, "os_lidar");
        ...
        nh.param<std::string>("lio_sam/sensor", sensorStr, "ouster");
        ...
        nh.param<int>("lio_sam/Horizon_SCAN", Horizon_SCAN, 1024);
        nh.param<int>("lio_sam/downsampleRate", downsampleRate, 1);
        nh.param<float>("lio_sam/lidarMinRange", lidarMinRange, 1.0);
        nh.param<float>("lio_sam/lidarMaxRange", lidarMaxRange, 1000.0);

        nh.param<float>("lio_sam/imuAccNoise", imuAccNoise, 3.9939570888238808e-03);
        nh.param<float>("lio_sam/imuGyrNoise", imuGyrNoise, 1.5636343949698187e-03);
        nh.param<float>("lio_sam/imuAccBiasN", imuAccBiasN, 6.4356659353532566e-05);
        nh.param<float>("lio_sam/imuGyrBiasN", imuGyrBiasN, 3.5640318696367613e-05);
        nh.param<float>("lio_sam/imuGravity", imuGravity, 9.80511);
        nh.param<float>("lio_sam/imuRPYWeight", imuRPYWeight, 0.001);
        ...
        nh.param<float>("lio_sam/edgeThreshold", edgeThreshold, 1.0);
        ...
        nh.param<float>("lio_sam/odometrySurfLeafSize", odometrySurfLeafSize, 0.4);
        nh.param<float>("lio_sam/mappingCornerLeafSize", mappingCornerLeafSize, 0.2);
        nh.param<float>("lio_sam/mappingSurfLeafSize", mappingSurfLeafSize, 0.4);
        ...
        nh.param<float>("lio_sam/surroundingKeyframeDensity", surroundingKeyframeDensity, 2.0);
        ...
        nh.param<float>("lio_sam/historyKeyframeSearchRadius", historyKeyframeSearchRadius, 15.0);
